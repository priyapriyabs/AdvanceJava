...
<form action="sendotp" method="post" modelAttribute="sendall" class="col-lg-4 reg_form  top">
 ...
 <p style="color: red;"> ${resteerror }</p>
  </div>
  <div>
 
   <button  class="btn btn-primary butt">Send OTP</button>
<%--  <h6 style="color: red;font-size: 15px;position: relative;top: -52px;"> ${otperr }</h6> --%>
  </div>
  
  <!-- <form action="resetpass" method="post" modelAttribute="resetall" class="col-lg-4 reg_form top"> -->
   <div>
   <%-- <h6 style="color: red;font-size: 15px;"> ${resteerror }</h6> --%>
