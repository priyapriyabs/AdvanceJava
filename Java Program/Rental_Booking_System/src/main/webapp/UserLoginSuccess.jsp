...
<div>
	...
	<span style="margin-left:16.2%;color: blue"><b>${noDue}</b></span>
		<table class="table w-auto table-bordered" style="margin-left:auto;margin-right:auto;margin-top:5%;">
	...
	<script
		...
		crossorigin="anonymous"></script>
	<div class="footer">
		<small style="color:white;">&copy; Created by: Priyanka B S,</small><small style="color:white;">&ensp;bspriya9912@gmail.com</small>&ensp;<small style="color:white;">|</small><small style="color:lightgreen;">&ensp;Last login time: ${userDto.updatedDate}</small>
	</div>
</body>
</html>