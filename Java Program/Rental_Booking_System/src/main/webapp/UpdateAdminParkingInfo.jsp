...
<script>
 ...
 <script>
	function ajax() {
		...
		var url2 = "http://localhost:8080/Rental_Booking_System/validateFields/"
...
<h5 style="color: green;">${success}</h5>
	<div class="card shadow" >
		...
		<div class="card-body">
			<form action="updateParkingInfo" modelAttribute="adminParking" method="post" onsubmit="return validateFields()" >
				...
				<div class="row">
					...
					<div class="col-md-6 mt-md-0 mt-3" >
						...
						<select name="term" id="term" onchange="ajax()" class="form-select shadow required"  onclick="enableSubmit()">
		...
		crossorigin="anonymous"></script>
	<div class="footer">
		<small style="color: white;">&copy; Created by: Priyanka B S,</small><small style="color: white;">&ensp;bspriya9912@gmail.com</small><small
