...
<div class="card-body" style="margin-top:5%;"> <!-- background-color:pink; -->
	<div class="row">
	<span style="margin-left:26%;color: blue;"><b>Profile</b></span>
			...
			<tbody style="text-align: center;font-size: 12px;">
				<c:forEach items="${parkingData}" var="dto">
					<tr>
						...
						<td>
							<%-- <a href="${pageContext.request.contextPath}/parkinginfo/byVehicleNo/${dto.vehicleNo}" --%>
							 <a href="parkinginfo?vehicleNo=${dto.vehicleNo}" class="btn btn-sm" style="background-color: turquoise;">Update</a>
						</td>
 						<td>
