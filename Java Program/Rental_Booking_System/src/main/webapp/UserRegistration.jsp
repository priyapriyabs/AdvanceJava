...
<script>
	function EmailAjax() {
		...
		var email = document.getElementById("email").value;
		var url = "http://localhost:8080/Rental_Booking_System/validateEmail/"
				+ email;
		//	console.log(url);
...
<script
	...
	<nav class="navbar fixed-top navbar-dark bg-dark" style="height: 50px;">
		<div class="container-fluid">
			<img src="/Rental_Booking_System/URLRESOURCE/img/Parking Space.jpeg" class="w3-bar w3-border" width="85px"
				height="40px">
...
<div class="wrapper rounded bg-white" style="margin-top:;">
		...
		<!-- <div class="col-lg-12 col-md-8 col-sm-8"> -->
				<div class="card shadow" style="background-color: ;">
					...
					<div class="card-body">
						<form action="userRegistration" method="post" enctype="multipart/form-data" onsubmit="return validateFields()">
				...
				<div class="row">
							<div class="col-md-6 mt-md-0 mt-3">
								...
								<select name="term" id="term"  onchange="ajaxWithObj()"
									 class="form-select shadow required " onclick="enableSubmit()" aria-label="Default select example">
	...
	<div class="footer">
		<small style="color: white;" style="color:white;">&copy;
			Created by: Priyanka B S,</small><small style="color: white;">&ensp;bspriya9912@gmail.com</small>
	</div>
</body>
</html>