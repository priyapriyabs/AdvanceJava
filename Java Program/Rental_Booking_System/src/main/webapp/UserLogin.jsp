...
var email=document.getElementById("email").value;
var url="http://localhost:8080/Rental_Booking_System/validateEmailForOPT/"+email;
console.log(url);
...
var url="http://localhost:8080/Rental_Booking_System/validateOTP/"+email+"/"+otp;
...
<body>
	<nav class="navbar fixed-top navbar-dark bg-dark" style="height: 50px;">
		<div class="container-fluid">
			<img src="/Rental_Booking_System/URLRESOURCE/img/Parking Space.jpeg" class="w3-bar w3-border" width="85" height="40">
...
<!-- 				    <div style="display: flex; width:80%;
		...
		<div class="row justify-content-center mt-5" >
			<div class="col-lg-6 col-md-8 col-sm-8" style="margin-top:3%;">
...
<span style="color:red;font-size: 12px;" id="emailDisplay">${emailError}</span> 
						<div class="row">
							<div class="col-md-7 mt-md-0 mt-3" > 
								<input type="email"  class="form-control shadow" onkeyup="enableSubmit()" id="email" name="email" value="${mail}" placeholder="Enter email address" onchange="EmailAjax()"/>
...
<br/><span style="color:red;font-size: 12px;" id="OtpDisplay">${otpError}</span>
	...
	<div class="footer">
	<small style="color: white;">&copy;Created by: </small><small style="color: white;">Priyanka B S,</small><small style="color: white;">&ensp;bspriya9912@gmail.com</small>
	</div>
</body>
</html>