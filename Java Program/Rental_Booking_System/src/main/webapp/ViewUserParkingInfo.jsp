...
<link rel="stylesheet"
	href="/Rental_Booking_System/URLRESOURCE/css/displaytag.css"
	type="text/css">
<link rel="stylesheet" href="css/screen.css" type="text/css">
<link rel="stylesheet" href="css/site.css" type="text/css">
<link rel="stylesheet"
	href="/Rental_Booking_System/URLRESOURCE/css/style.css">
<style>
...
<body style="margin-top: 10%; margin-bottom: 5%">
	...
	<nav class="navbar fixed-top navbar-dark bg-dark" style="height: 50px;">
		<div class="container-fluid">
			<div class="navbar-header">
				<img src="/Rental_Booking_System/URLRESOURCE/img/Parking Space.jpeg"
					class="w3-bar w3-border" width="85" height="40"
	...
	<script
		...
		crossorigin="anonymous"></script>
	<div class="footer">
		<small style="color: white;">&copy; Created by: Priyanka B S ,</small><small
			style="color: white;">&ensp;bspriya9912@gmail.com</small><small
