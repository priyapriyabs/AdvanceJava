...
<div class="card-body" style="margin-left: 0%;margin-right: 0%; margin-top: 50px;"> <!-- background-color:pink; -->
...
<input class="btn w-40" style="background-color: turquoise; margin-right: 80px; font-weight: bold;" type="submit" value="Search"/>
	...
	<script
		...
		crossorigin="anonymous"></script>
	<div class="footer">
		<small style="color:white;">&copy; Created by: Priyanka B S,</small><small style="color:white;">&ensp;bspriya9912@gmail.com</small><small style="color:green;"> | Last login time: ${sessionDTO.loginTime}</small>
	</div>
</body>
</html>