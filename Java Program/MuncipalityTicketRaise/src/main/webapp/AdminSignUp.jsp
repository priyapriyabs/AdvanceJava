...
<c:choose>
    <c:when test="${admin}">
        <form action="admin/signup" method="post" modelAttribut="adminDto">
    </c:when>
     ...
     <div class="container mt-5 mb-5 d-flex justify-content-center">
           <div class="card px-5 py-4 bg-light shadow p-3 mb-5 bg-white rounded">
               <div class="card-body">
<span  class="text-danger"> ${dataRequiredError }</span>
                   <h6 class="card-title mb-3 text-dark fs-2">Sign Up</h6>
 <div class="mb-3">
                                       <label for="name" class="form-label text-dark">Admin Name</label>
                    ...
                    <div class="mb-3">
                                       ...
                                       <span id="emailError" class="text-danger"> ${adminerror }</span>
                                   </div>
